...
class LigongUniversityNo17(object):
    ...
    def start(self):
        ...
        links = []
        nums=self.driver.find_elements(By.XPATH,'//*[@class="con_left"]//li[1]//following-sibling::*//a')
        for n in nums:
            # print(n.text)
        ...
        for link in links:
            ...
            counts=self.driver.find_elements(By.XPATH,'//*[@class="teacherlist"]//dd')
            print(len(counts))
            for c in counts:
                ...
                introduces=self.driver.find_elements(By.XPATH,'//*[@class="teacher_xq"]')
                if len(introduces)!=0:
...
if __name__ == '__main__':
    #在职教师
    one_url ='https://marx.bit.edu.cn/szdw/gk/index.htm'
    #学校
    school='北京理工大学-马克思主义学院'
    demo = LigongUniversityNo17(one_url,school)
    demo.start()
