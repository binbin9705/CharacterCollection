...
class LigongUniversityNo13(object):
    ...
    def start(self):
        ...
        for link in links:
            ...
            counts=self.driver.find_elements(By.XPATH,'//*[@class="list01 list001"]//li')
            types=self.driver.find_element(By.XPATH, '//*[@class="listTitle01 "]//h2').text
            print(types)
            print(len(counts))
            for c in counts:
                ...
                # print(introduce)
                if "职称：" in introduce:
                    title = introduce.split("职称：")[1].split("职务：")[0]
                else:
                    title = ''
                if "研究方向\n" in introduce:
                ...
                if "联系方式：" in introduce:
                    phone = introduce.split("联系方式：")[1].split("\n")[0]
                else:
                    phone = ''
                if "电子邮件："in introduce:
                    mailbox = introduce.split("电子邮件：")[1].split("联系方式：")[0]
                else:
                    mailbox = ''
                data = {}
                data['姓名'] = name
...
if __name__ == '__main__':
    #在职教师
    one_url ='https://ac.bit.edu.cn/szdw/jsml/kzllykzgcyjs1/index.htm'
    #学校
    school='北京理工大学-自动化学院'
    demo = LigongUniversityNo13(one_url,school)
    demo.start()
