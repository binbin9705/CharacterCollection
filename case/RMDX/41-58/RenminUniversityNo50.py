...
class RenminUniversityNo50(object):
    ...
    def start(self):
        ...
        counts=self.driver.find_elements(By.XPATH,'//div[@class="team_b_b container"]//li')
        print(len(counts))
        for c in counts:
            name=c.find_element(By.XPATH,'.//span').text
            print(name)
            ...
            phone=''
            mailbox=''
            introduces=self.driver.find_elements(By.XPATH,'//*[@class="dr fl"]')
...
if __name__ == '__main__':
    # 在职教师
    one_url = 'http://ztzx.ruc.edu.cn/yjtd/zzyjy/index.htm'
    # 学校
    school = '人民大学-全国中国特色社会主义政治经济学研究中心'
    demo = RenminUniversityNo50(one_url, school)
    demo.start()
